...
import SaveForm from "./_components.tsx/saveForm";
    ...
    <div className="py-32 h-full">
      <div className="flex flex-col space-y-3">
        ...
        <p className="text-muted-foreground max-w-lg">
          ...
          narratives to find inspirations, learn from others experiences, and
          see the diverse paths people have taken in their careers.
        </p>
      </div>
        ...
        {stories.map((story) => (
          <Card key={story.id}>
            {story.image ? (
              ...
              <div className="h-52 w-full flex items-center justify-center aspect-video bg-secondary rounded-md">
